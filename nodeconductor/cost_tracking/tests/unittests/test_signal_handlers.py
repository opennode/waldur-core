...
class PriceListItemsHandlersTest(TestCase):
    ...
    def setUp(self):
        ...
        self.oracle_resource_content_type = ContentType.objects.get_for_model(oracle_models.OracleService)

    def test_new_price_list_item_will_be_created_on_default_item_creation(self):
        default_item = factories.DefaultPriceListItemFactory(resource_content_type=self.oracle_resource_content_type)
