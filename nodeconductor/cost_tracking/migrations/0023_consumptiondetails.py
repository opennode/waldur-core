    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('configuration', nodeconductor.core.fields.JSONField(default={}, help_text='Current resource configuration.')),
                ('last_update_time', models.DateTimeField(help_text='Last configuration change time.')),
                ('consumed_before_update', nodeconductor.core.fields.JSONField(default={}, help_text='How many consumables were used by resource before last update.')),
