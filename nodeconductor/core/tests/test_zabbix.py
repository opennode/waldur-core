...
class ZabbixPublicApiTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.z = zabbix.Zabbix(self.zabbix_parameters)
        self.z.get_zabbix_api = Mock(return_value=self.api)
    ...
    def test_create_host_creates_group_if_it_does_not_exist(self):
        ...
        self.z.create_host(self.instance)

        expected_group_name = self.z.get_hostgroup_name(self.project)
    ...
    def test_create_host_creates_new_host_if_it_does_not_exist(self):
        ...
        expected_host_name = self.z.get_host_name(self.instance)
    ...
    def test_create_host_raises_zabbix_error_on_api_exception(self):
        ...
        self.assertRaises(zabbix.ZabbixError, lambda: self.z.create_host(self.instance))

    # Host deletion
    def test_delete_host_deletes_host_if_it_exists(self):
        self.z.delete_host(self.instance)
    ...
    def test_delete_host_raises_zabbix_error_on_api_exception(self):
        ...
        self.assertRaises(zabbix.ZabbixError, lambda: self.z.delete_host(self.instance))

    # Hostgroup creation
    def test_create_hostgroup_creates_new_hostgroup_if_it_does_not_exist(self):
        self.api.hostgroup.exists.return_value = False

        self.z.create_hostgroup(self.project)

        expected_hostgroup_name = self.z.get_hostgroup_name(self.project)
    ...
    def test_create_hostgroup_raises_zabbix_error_on_api_exception(self):
        ...
        self.assertRaises(zabbix.ZabbixError, lambda: self.z.create_hostgroup(self.project))

    # Hostgroup deletion
    def test_delete_hostgroup_deletes_host_if_it_exists(self):
        self.z.delete_hostgroup(self.project)
    ...
    def test_delete_hostgroup_raises_zabbix_error_on_api_exception(self):
        ...
        self.assertRaises(zabbix.ZabbixError, lambda: self.z.delete_hostgroup(self.project))

    # Service creation
    def test_create_service_uses_given_template_trigger(self):
        self.z.create_service(self.instance)
    ...
    def test_create_service_creates_new_service_if_it_does_not_exist(self):
        ...
        expected_service_name = self.z.get_service_name(self.instance)
    ...
    def test_create_service_raises_zabbix_error_on_api_exception(self):
        ...
        self.assertRaises(zabbix.ZabbixError, lambda: self.z.create_service(self.instance))

    # Service deletion
    def test_delete_service_deletes_host_if_it_exists(self):
        self.z.delete_service(self.instance)
    ...
    def test_delete_service_raises_zabbix_error_on_api_exception(self):
        ...
        self.assertRaises(zabbix.ZabbixError, lambda: self.z.delete_service(self.instance))
