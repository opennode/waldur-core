...
def change_flavor(instance_uuid, flavor_uuid):
    change_instance_flavor.apply_async(
...
@save_error_message
def change_instance_flavor(instance_uuid, flavor_uuid, transition_entity=None):
