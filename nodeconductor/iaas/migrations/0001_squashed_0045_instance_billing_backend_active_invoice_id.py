    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_backend_purchase_order_id', models.CharField(help_text=b'ID of a purchase order in backend that created a resource', max_length=255, blank=True)),
                ('billing_backend_template_id', models.CharField(help_text=b'ID of a template in backend used for creating a resource', max_length=255, blank=True)),
                ('billing_backend_active_invoice_id', models.CharField(help_text=b'ID of an active invoice in backend', max_length=255, blank=True)),
            ],
            options={
                'abstract': False,
            },
