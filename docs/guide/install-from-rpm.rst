...
Note that database server (MySQL or PostgreSQL) and key-value store (Redis) may run on a separate servers -- in this case modify installation process accordingly.
