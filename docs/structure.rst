...
.. glossary::
    ...
    Project
      A project is an entity within a customer. Project is managed by users having different roles. Project
    ...
    User
      ...
      A user can work in different projects with different roles. Customer is derived based on what projects
